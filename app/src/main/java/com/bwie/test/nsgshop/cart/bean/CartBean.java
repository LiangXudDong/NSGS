package com.bwie.test.nsgshop.cart.bean;
...
public class CartBean {
    ...
    public static class DataBean {
        ...
        private boolean sjis;

        public boolean isSjis() {
            return sjis;
        }

        public void setSjis(boolean sjis) {
            this.sjis = sjis;
        }

        public DataBean(String sellerName) {
        ...
        public static class ListBean {
            ...
            public ListBean(double bargainPrice, String createtime, String detailUrl, String images, int num, int pid, double price, int pscid, int selected, int sellerid, String subhead, String title, boolean cis) {
