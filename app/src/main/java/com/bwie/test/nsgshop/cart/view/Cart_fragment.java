...
public class Cart_fragment extends MyBaseFragment implements Iview,BaseFragment{
    ...
    private void initView() {
        num = (TextView)view.findViewById(R.id.main_num);
        expandableListView = (ExpandableListView) view.findViewById(R.id.expand_able_view);
        checkAll = (CheckBox)view. findViewById(R.id.main_check_all);
        btnDel = (Button)view.findViewById(R.id.btn_delete);
        btnBuy = (Button) view.findViewById(R.id.btn_buy);
        price = (TextView) view.findViewById(R.id.main_price);
    }
