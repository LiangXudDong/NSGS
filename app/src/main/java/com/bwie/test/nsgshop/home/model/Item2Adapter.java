...
public class Item2Adapter extends RecyclerView.Adapter<Item2Adapter.MyViewHolder>{
    ArrayList<User> mDatas;
    Context context;
    public Item2Adapter(ArrayList<User> mDatas, Context context) {
        this.mDatas = mDatas;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                context).inflate(R.layout.home_jp, parent,
                false));
        return holder;
    }
